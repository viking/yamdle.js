define([
  ...
  return new prod.Suite('yamdle', {
    'stringify': new prod.Suite('stringify', {
    ...
    'parse': new prod.Suite('parse', {
      'plain string': function() {
        this.assertEquals("foo", yamdle.parse("foo"));
      },

      'non-plain string with quote': function() {
        this.assertEquals('!f"oo', yamdle.parse('"!f\\"oo"'));
      },
      ...
      'number string': function() {
        this.assertEquals("123", yamdle.parse('"123"'));
      },

      'float string': function() {
        this.assertEquals("123.4", yamdle.parse('"123.4"'));
      },

      'boolean string': function() {
        this.assertEquals("true", yamdle.parse('"true"'));
        this.assertEquals("false", yamdle.parse('"false"'));
      },

      'null string': function() {
        this.assertEquals("null", yamdle.parse('"null"'));
      },
